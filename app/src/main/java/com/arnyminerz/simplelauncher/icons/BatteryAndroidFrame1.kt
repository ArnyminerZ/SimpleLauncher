...
val MaterialSymbols.BatteryAndroidFrame1: ImageVector
    get() {
        if (_BatteryAndroidFrame1 != null) {
            return _BatteryAndroidFrame1!!
        }
        _BatteryAndroidFrame1 = ImageVector.Builder(
...
private var _BatteryAndroidFrame1: ImageVector? = null
